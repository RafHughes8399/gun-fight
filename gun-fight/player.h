...
public:
	...
	player(std::shared_ptr<entities::gunman> gunman, std::shared_ptr<entities::weapon> weapon, std::map<int, Vector2>& movement_keys, std::pair<int, int>& fire_reload_keys)
